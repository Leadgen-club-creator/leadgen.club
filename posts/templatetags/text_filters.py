...
def resized_image(value, arg="full"):
    if not value or "://i.clubleadgen.ru/" not in value:
        return value

    if is_video(value):
        return value

    if value.startswith("https://i.clubleadgen.ru/full/"):
        return value.replace(
            "https://i.clubleadgen.ru/full/", "https://i.clubleadgen.ru/{}/".format(arg)
        )
    else:
        return value
