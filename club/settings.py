...
ALLOWED_HOSTS = ["*", "127.0.0.1", "localhost", "0.0.0.0", "clubleadgen.ru"]
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "glader.ru@gmail.com")

# App

APP_HOST = os.environ.get("APP_HOST") or "http://127.0.0.1:8000"
APP_NAME = "Лидген.Клуб"
...
MEDIA_UPLOAD_URL = "https://i.clubleadgen.ru/upload/multipart/"
MEDIA_UPLOAD_CODE = os.getenv("MEDIA_UPLOAD_CODE")
VIDEO_EXTENSIONS = {"mp4", "mov", "webm"}
IMAGE_EXTENSIONS = {"jpg", "jpeg", "png", "gif"}

OG_IMAGE_GENERATOR_URL = "https://og.clubleadgen.ru/preview"
OG_IMAGE_DEFAULT = "https://clubleadgen.ru/static/images/share.png"
OG_MACHINE_AUTHOR_LOGO = "https://clubleadgen.ru/static/images/the_machine_logo.png"
OG_IMAGE_GENERATOR_DEFAULTS = {
    "logo": "https://clubleadgen.ru/static/images/logo/logo-white-text.png",
    "op": 0.6,
    "bg": "#FFFFFF",
}
...
TELEGRAM_BOT_WEBHOOK_URL = "https://clubleadgen.ru/telegram/webhook/"
...
DEFAULT_AVATAR = "https://i.clubleadgen.ru/v.png"
...
CLEARED_POST_TEXT = "```\n" \
    ...
    "Если вы хотите приютить и развить эту тему как новый автор, напишите модераторам Клуба: moderator@clubleadgen.ru." \
    "\n```"
